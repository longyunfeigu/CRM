...
(function (f, h) {
    ...
    f.widget = function (o, d, p) {
        ...
        f.extend(e, b, {version: p.version, _proto: f.extend({}, p), _childConstructors: []});
        c = new d();
        ...
        e.prototype = f.widget.extend(c, {widgetEventPrefix: o}, p, {
            constructor: e,
            namespace: n,
            widgetName: o,
            widgetBaseClass: a,
    ...
    f.Widget.prototype = {
        ...
        _on: function (a, b) {
            ...
            var c = this;
            f.each(b, function (r, d) {
                function o() {
                    if (c.options.disabled === true || f(this).hasClass("ui-state-disabled")) {
                        return;
                    }
                    return (typeof d === "string" ? c[d] : d).apply(c, arguments);
                }

                if (typeof d !== "string") {
                    o.guid = d.guid = d.guid || o.guid || f.guid++;
                }
                var e = r.match(/^(\w+)\s*(.*)$/), p = e[1] + c.eventNamespace, q = e[2];
                if (q) {
    ...
    f.each({show: "fadeIn", hide: "fadeOut"}, function (a, b) {
...
(function (a, b) {
    a.widget("bootstrap.bwizard", {
        ...
        //     }
            ...
            //     }
            //     if (g != "") {
            //         this.nextBtn = a("<li class='next'><a href='#'>" + g + "</a>").appendTo(this.buttons).bind({
            //             click: function () {
            //                 e.next();
            //                 return false;
            //             }
        ...
        _refreshStep: function () {
            ...
            if (this.lis) {
                ...
                if (c.activeIndex >= 0 && c.activeIndex <= this.lis.length - 1) {
                    if (this.lis) {
                        this.lis.eq(c.activeIndex).addClass("active").attr("aria-selected", true).find(".label").addClass("badge-inverse");
                    }
                }
            }
