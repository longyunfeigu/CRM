# -*- coding: utf-8 -*-
# Generated by Django 1.11.3 on 2017-10-19 11:50
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('branch', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='my_crm.Branch', verbose_name='校区')),
            ],
            options={
                'verbose_name': '班级',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('from_class', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='my_crm.ClassList', verbose_name='班级')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('consult_course', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='my_crm.Course', verbose_name='咨询课程')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('customer', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='my_crm.Customer')),
            ],
            options={
                'verbose_name': '客户跟进记录',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('customer', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='my_crm.Customer')),
                ('enrolled_class', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='my_crm.ClassList', verbose_name='所报班级')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('name', models.CharField(max_length=32)),
                ('url_type', models.PositiveSmallIntegerField(choices=[(0, 'alias'), (1, 'absolute_url')], default=0)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('date', models.DateTimeField(auto_now_add=True)),
                ('consultant', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to=settings.AUTH_USER_MODEL)),
                ('course', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='my_crm.Course', verbose_name='所报课程')),
                ('customer', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='my_crm.Customer')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('menus', models.ManyToManyField(blank=True, to='my_crm.Menu')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('date', models.DateField(auto_now_add=True)),
                ('course_record', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='my_crm.CourseRecord')),
                ('student', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='my_crm.Enrollment')),
            ],
            options={
        ...
        migrations.AddField(
            model_name='customer',
            name='tags',
            field=models.ManyToManyField(blank=True, null=True, to='my_crm.Tag'),
        ),
        migrations.AddField(
            model_name='classlist',
            name='course',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='my_crm.Course'),
        ),
        migrations.AddField(
            model_name='classlist',
            name='teachers',
