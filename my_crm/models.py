...
class Customer(models.Model):
    ...
    email = models.EmailField(verbose_name="常用邮箱")
    ...
    consultant = models.ForeignKey("UserProfile", verbose_name='咨询人')
...
class StudyRecord(models.Model):
    ...
    memo = models.TextField(blank=True,null=True,help_text='老师评语')
    date = models.DateField(auto_now_add=True)
...
class Menu(models.Model):
    ...
    url_type = models.PositiveSmallIntegerField(choices=url_type_choices, default=0)
